...
export const CallToAction = () => {
  ...
  return (
    <div
      className="py-20 md:py-24 flex justify-center items-center"
      ref={sectionRef}
    >
      <div className="container">
        ...
        >
          ...
          <div className="relative">
            <h2 className="text-5xl md:text-6xl max-w-3xl mx-auto tracking-tighter text-center font-medium">
              AI-driven Optimization for everyone.
            </h2>
